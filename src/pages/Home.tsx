    ...
    <Box bg={pageBg} minH="100vh">
      ...
      <Box bg={heroBg} color="white" textAlign="center" py={16} px={6}>
        ...
        <Text fontSize="md" maxW="480px" mx="auto" lineHeight={1.8}>
          גמ"ח הנשיאה שלנו פועל בירושלים לטובת קהילת הנשיאה המקומית.
          <br />
        ...
        <Text fontSize="sm" maxW="480px" mx="auto">
          שמחות שפנית אלינו!
          <br />
          ההשאלה מהגמ"ח היא חינם לתקופה של חודש, וניתנת להארכה לאחר אישורנו ובתשלום של 20 ש"ח על כל
          חודש נוסף. <br />
          הכסף משמש אותנו לתחזוקה של הגמ"ח ורכישת מנשאים חדשים במידת הצורך. <br />
          הגמ"ח מופעל בהתנדבות מלאה! אנו משתדלות לתת מענה בהקדם האפשרי, אבל זה יכול לקחת יום-יומיים
          ואפילו קצת יותר אנא היאזרו בסבלנות.
          <br />
